    ...
    this.setState(
      () => {
        return {
          cart: [...tempCart],
          products: [...tempProducts],
          cartSubTotal: this.state.cartSubTotal - removedProduct.total,
          cartTax: this.state.cartTax - removedProduct.total * 0.1,
          cartTotal: this.state.cartTotal - removedProduct.total,
        };
      },
      //! setState is a method
      () => {
